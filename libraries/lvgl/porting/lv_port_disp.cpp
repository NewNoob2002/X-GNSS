#include "porting/lv_port.h"
#include <Adafruit_ST7789.h>
#include "HAL.h"

extern Adafruit_ST7789 screen;

#define SCREEN_BUFFER_SIZE (CONFIG_SCREEN_WIDTH * CONFIG_SCREEN_HIEGHT)
...
static void disp_flush_cb(lv_disp_drv_t *disp, const lv_area_t *area, lv_color_t *color_p)
{
    ...
    for (int i = 0; i < len; i++)
    {
        screen.pushColor(*(uint16_t *)color_p);
    }
